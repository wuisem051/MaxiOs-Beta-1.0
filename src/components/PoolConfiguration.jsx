...
const PoolConfiguration = () => {
  ...
  const handleSaveConfig = async () => {
    try {
      ...
      alert('Configuración de la Pool guardada exitosamente en Firebase!');
    } catch (error) {
      console.error('Error al guardar la configuración de la Pool en Firebase:', error);
      alert('Error al guardar la configuración de la Pool.');
    }
  };
  ...
  return (
    <div className="bg-gray-900 text-white p-8 rounded-lg shadow-lg max-w-5xl mx-auto my-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <a href="http://localhost:3001" target="_blank" rel="noopener noreferrer" className="text-yellow-500 hover:underline flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-4">Configuración de Pagos</h3>
          <div className="mb-4">
            <label htmlFor="poolCommission" className="block text-gray-400 text-sm mb-1">Comisión de la Pool (%)</label>
            <input
              type="number"
              id="poolCommission"
          ...
          <div className="mb-4">
            <label htmlFor="obsoletePrice" className="block text-gray-400 text-sm mb-1">Precio por TH/s (USD)</label>
            <input
              type="number"
              id="obsoletePrice"
              value={obsoletePrice}
          ...
          <div className="mb-4">
            <label htmlFor="bitcoinAddress" className="block text-gray-400 text-sm mb-1">Dirección de Pago (Bitcoin)</label>
            <input
              type="text"
              id="bitcoinAddress"
          ...
          <div className="mb-4">
            <label htmlFor="minPaymentThresholdBTC" className="block text-gray-400 text-sm mb-1">Umbral mínimo de pago (BTC)</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label htmlFor="minPaymentThresholdDOGE" className="block text-gray-400 text-sm mb-1">Umbral mínimo de pago (DOGE)</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label htmlFor="minPaymentThresholdLTC" className="block text-gray-400 text-sm mb-1">Umbral mínimo de pago (LTC)</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label htmlFor="minPaymentThresholdUSD" className="block text-gray-400 text-sm mb-1">Umbral mínimo de pago (USD)</label>
            <input
              type="number"
          ...
          <div className="mb-4">
            <label htmlFor="paymentInterval" className="block text-gray-400 text-sm mb-1">Intervalo de pago</label>
            <select
              id="paymentInterval"
          ...
          <div className="mb-4">
            <h4 className="text-gray-400 text-sm mb-2">Monedas de Pago Soportadas</h4>
            <div className="flex items-center space-x-4">
              <label className="inline-flex items-center">
                ...
                />
                <span className="ml-2 text-gray-300">Bitcoin</span>
              </label>
              <label className="inline-flex items-center">
                <input
                  type="checkbox"
                ...
                />
                <span className="ml-2 text-gray-300">Dogecoin</span>
              </label>
              <label className="inline-flex items-center">
                <input
                  type="checkbox"
                ...
                />
                <span className="ml-2 text-gray-300">Litecoin</span>
              </label>
            </div>
          </div>
          <div className="mb-6">
            <label className="inline-flex items-center">
              ...
              />
              <span className="ml-2 text-gray-300">Habilitar Binance Pay</span>
            </label>
          </div>
          <button
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-4">Configuración de Minería</h3>
          <div className="mb-4">
            <label htmlFor="poolUrl" className="block text-gray-400 text-sm mb-1">URL del Pool</label>
            <input
              type="text"
              id="poolUrl"
              value={poolUrl}
          ...
          <div className="mb-4">
            <label htmlFor="poolPort" className="block text-gray-400 text-sm mb-1">Puerto del Pool</label>
            <input
              type="text"
              id="poolPort"
              value={poolPort}
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:outline-none focus:border-blue-500 text-white"
            />
            <p className="text-gray-500 text-sm mt-1">Se mostrará como: usuario.worker_name en la página principal</p>
          </div>
          <button
            onClick={handleSaveConfig}
            className="w-full bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-200"
